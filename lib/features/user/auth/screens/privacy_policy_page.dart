          ...
          child: DefaultTextStyle(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  '- 소셜 로그인 정보',
                  style: TextStyle(fontFamily: 'ScoreMedium'),
                ),
                Text(
                ...
                Text('- 상점 이용 기록', style: TextStyle(fontFamily: 'ScoreMedium')),
                SizedBox(height: 10.h),
                Text(
                  '③ 결제 및 광고 관련 정보',
                  style: TextStyle(
                ...
                Text(
                  '- 광고 식별자(AD ID) 등 광고 제공을 위한 정보(광고 플랫폼에서 자동 수집될 수 있음)',
                  style: TextStyle(fontFamily: 'ScoreMedium'),
                ),
                SizedBox(height: 10.h),
                Divider(),
                ...
                Text(
                  '- 본 서비스는 Supabase를 이용하여 개인정보를 안전하게 저장 및 관리합니다.',
                  style: TextStyle(fontFamily: 'ScoreMedium'),
                ),
                Text(
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: const Text(
                        ...
                        style: TextStyle(
                          color: Color.fromARGB(255, 59, 6, 92),
                          fontFamily: 'ScoreMedium',
                        ),
                      ),
                    ),
