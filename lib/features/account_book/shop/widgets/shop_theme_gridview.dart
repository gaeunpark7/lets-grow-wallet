...
class ShopThemeGridview extends StatefulWidget {
  final Function(Map<String, dynamic>) onItemSelected;

  const ShopThemeGridview({super.key, required this.onItemSelected});
  @override
  State<ShopThemeGridview> createState() => _ShopThemeGridviewState();
}

class _ShopThemeGridviewState extends State<ShopThemeGridview> {
  @override
